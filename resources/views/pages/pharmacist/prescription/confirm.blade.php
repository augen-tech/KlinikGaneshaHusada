...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">Konfirmasi Resep</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Resep</a></li>
            <li class="breadcrumb-item active">Konfirmasi Resep</li>
        </ol>
    </div>
</div>
@endsection
                ...
                @foreach($prescriptions as $key=> $row)
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a href="{{ route('pharmacist.prescription.accept', $row->id) }}" data-toggle="tooltip" data-original-title="Proses"> <i class="fa fa-check m-r-10"></i> </a>
